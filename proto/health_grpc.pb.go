...
type HealthCheckClient interface {
	Check(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*HealthResponse, error)
}
...
func (c *healthCheckClient) Check(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/memcache.HealthCheck/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HealthCheckServer interface {
	Check(context.Context, *EmptyRequest) (*HealthResponse, error)
...
func (UnimplementedHealthCheckServer) Check(context.Context, *EmptyRequest) (*HealthResponse, error) {
...
func _HealthCheck_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/memcache.HealthCheck/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServer).Check(ctx, req.(*EmptyRequest))
	}
...
var HealthCheck_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "memcache.HealthCheck",
